    ...
    <div class="p-5">
        ...
        <form>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select v-model="booktoreturn" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
            ...
            <div class="form-group row">
                <div class="col-sm-10">
                    <button @click.prevent="updateIssuedBookData()" type="submit"
...
export default {
    ...
    methods: {
        ...
        getBook() {
            var _this = this
            axios.get('http://localhost:3000/books/' + _this.booktoreturn)
                .then(function (response) {
        ...
        updateBook(bookData) {
            ...
            bookData.total_books = bookData.issued_copies + bookData.available_copies
            axios.put('http://localhost:3000/books/' + _this.booktoreturn, bookData)
                .then(function () {
        ...
        updateIssuedBookData() {
            console.log(this.booktoreturn)
            console.log(this.issuedBook)
            var _this = this
            var issuedBook = this.issuedBook.find(item => item.book_id == this.booktoreturn);
