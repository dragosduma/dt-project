    ...
    <div id="issueBookForm" style="text-align:left">
      <form>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select v-model="issueBookData.student_id" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
              ...
              <option v-for="student in StudentList" :key="student.id" :value="student.id">{{ student.first_name }}
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input v-model="issueBookData.issue_date" type="date" class="form-control" id="issueDate" />
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input v-model="issueBookData.return_date" type="date" class="form-control" id="returnBook" />
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input v-model="issueBookData.issued_copies" type="number" class="form-control" id="issuedCopies"
